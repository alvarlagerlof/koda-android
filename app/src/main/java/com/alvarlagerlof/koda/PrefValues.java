...
public class PrefValues {
    ...
    public static final String URL_PROJECTS_SYNC = BASE_URL + API_VERSION + "synkronisera";
    ...
    public static final String URL_LOGIN_STATUS = BASE_URL + API_VERSION + "synkroinsera";
